...
int main(int argc, char** argv) {
  ...
  // K = [J11 J12 J21 J22 J31 J32]^T, J elements are based on full linear model.
  ...
  std::cout << "K = [J11 J12 J21 J22 J31 J32]^T, J elements are based on the full linear model.\n";
